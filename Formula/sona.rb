class Sona < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://s3.ctl.qzz.io/artifact/sona/sona-darwin-amd64"
      sha256 "436f472752a4f62dd4add087cb5f96012517563bd2987048746211338e1bc8c1"
    else
      url "https://s3.ctl.qzz.io/artifact/sona/sona-darwin-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://s3.ctl.qzz.io/artifact/sona/sona-linux-amd64"
      sha256 "6ea4926e89357690fc77db97551ed60b0a51762193246be2b468fcb57f04c7ef"
    else
      url "https://s3.ctl.qzz.io/artifact/sona/sona-linux-arm64"
